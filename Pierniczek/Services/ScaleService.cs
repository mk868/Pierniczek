...
namespace Pierniczek.Services
{
    public class ScaleService : IScaleService
    {
        ...
        public void Discretization(DataModel model, string columnName, string newColumnName, IList<RangeModel> ranges)
        {
            ...
            {
                var value = (double)row[columnName];
                ...
                row[newColumnName] = rangeNum.Value + 1;
            }
        }
    }
}
